...
exports.ListAllHistoricalWordsService = void 0;
...
class ListAllHistoricalWordsService {
    execute({ user_id }) {
        return __awaiter(this, void 0, void 0, function* () {
            let word = "";
            let index = -1;
            const historicalWords = yield prisma_1.default.historical.findMany({
                where: {
                    user_id: user_id,
                },
            });
...
exports.ListAllHistoricalWordsService = ListAllHistoricalWordsService;
